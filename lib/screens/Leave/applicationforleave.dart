...
class ApplicationForleave extends StatefulWidget {
  @override
  _ApplicationForleaveState createState() => _ApplicationForleaveState();
}

class _ApplicationForleaveState extends State<ApplicationForleave> {
  @override
